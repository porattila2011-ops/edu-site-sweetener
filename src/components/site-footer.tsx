...
return ( <footer className="mt-24 border-t border-border/60 bg-sidebar"> <div className="container-page grid gap-10 pt-14 pb-8 md:grid-cols-2 lg:grid-cols-4"> <div className="lg:col-span-2"> <div className="flex items-center gap-3"> <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary text-primary-foreground font-display text-lg font-extrabold">
MI </span> <span className="font-display text-lg font-extrabold">
Dr. Molnár István EGYMI </span> </div>
